...
try:
    ...
    try:
        import soma.info
        release = '.'.join([soma.info.version_major, soma.info.version_minor])
    except:
        release = '4.5'
...
latex_documents = [
  ('index', 'somaio.tex', u'Soma-IO Documentation',
   u'someone', 'manual'),
]
